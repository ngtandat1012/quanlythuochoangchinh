    ...
    <section class="wrapper site-min-height">
        ...
        <section class="">
            <header class="panel-heading">
                <?php echo ('Danh sách thuốc'); ?> 
                <div class="col-md-4 no-print pull-right"> 
                    <a data-toggle="modal" href="#myModal">
                        <div class="btn-group pull-right">
                            <button id="" class="btn green btn-xs">
                                <i class="fa fa-plus-circle"></i> <?php echo ('Thêm danh mục'); ?>
                            </button>
                        </div>
                    </a>
                </div>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <!-- <th> <?php echo ('Hạn sử dụng'); ?></th> -->
                                <th> <?php echo ('Chức năng'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        foreach ($medicines as $medicine) {
                            ...
                            <tr class="">
                                ...
                                <!-- <td> <?php
                                    ...
                                    ?>
                                    <button type="button" class="btn btn-info btn-xs btn_width load" data-toggle="modal" data-id="<?php echo $medicine->id; ?>"> <?php echo ('Thêm'); ?></button> 
                                </td> -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">  <?php echo ('Thêm tên thuốc'); ?></h4>
            </div>
            <div class="modal-body row">
                <form role="form" action="medicine/addNewMedicine" class="clearfix" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-5">
                        <label for="exampleInputEmail1"> <?php echo ('Tên thuốc'); ?></label>
                        <input type="text" class="form-control" name="name" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-5">
                        <label for="exampleInputEmail1"> <?php echo ('Danh mục'); ?></label>
                    ...
                    <!-- <div class="form-group col-md-3">
                        <label for="exampleInputEmail1"> <?php echo ('Hạn sử dụng'); ?></label>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">  <?php echo ('Chỉnh sửa thuốc'); ?></h4>
            </div>
            <div class="modal-body row">
...
<div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">  <?php echo ('Thêm thuốc'); ?></h4>
            </div>
