...
class Medicine extends MX_Controller {
    ...
    public function addNewMedicine() {
        ...
        $this->form_validation->set_rules('generic', 'Generic Name', 'trim||max_length[100]|xss_clean');
        // Validating Company Name Field
        $this->form_validation->set_rules('company', 'Company', 'trim||max_length[100]|xss_clean');
    ...
    public function addNewCategory() {
        ...
        $this->form_validation->set_rules('description', 'Description', 'trim||min_length[5]|max_length[100]|xss_clean');
        if ($this->form_validation->run() == FALSE) {
            $data['settings'] = $this->settings_model->getSettings();
            $this->load->view('home/dashboard', $data); // just the header file
            $this->load->view('add_new_category_view');
