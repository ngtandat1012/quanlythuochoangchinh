                ...
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                <th> <?php echo ('STT'); ?></th>
                                <th> <?php echo ('Ngày khám '); ?></th>
                                <th> <?php echo ('Họ tên và lớp'); ?></th>
                                <th> <?php echo ('MSSV'); ?></th>
                                <th> <?php echo ('Số BHYT'); ?></th>
                                <th> <?php echo ('Giới tính'); ?></th>
                                <th> <?php echo ('Chuẩn đoán'); ?></th>
                                <th> <?php echo ('Toa thuốc'); ?></th>
                            ...
                            <td class="medici_name"><?php echo $i; ?></td>
                                ...
                                <!-- <td> 
                                    ...
                                    if (!empty($prescription_patient)) {
                                        echo $prescription_patient->phone;
                                    }
                                    ?>
                                </td> -->
                                ...
                                <td> 
                                    ...
                                    $prescription_patient = $this->patient_model->getPatientById($prescription->patient);
                                    if (!empty($prescription_patient)) {
                                        echo $prescription_patient->email;
                                    }
                                    ?>
                                </td>
