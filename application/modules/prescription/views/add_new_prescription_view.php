...
<section id="main-content">
                        ...
                        <form role="form" action="prescription/addNewPrescription" class="clearfix" method="post" enctype="multipart/form-data">
                            <div class="">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="exampleInputEmail1"> <?php echo ('Ngày khám'); ?></label>
                                ...
                                <!-- <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control m-bot15 js-example-basic-single" name="patient" value=''>
                                        <?php foreach ($patients as $patient) { ?>
                                            ...
                                            ?> > <?php echo $patient->address; ?> </option>
                                                <?php } ?> 
                                    </select>
                                </div>
                                 -->
 ...
 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label class="control-label"><?php echo ('Chuẩn đoán'); ?></label>
                                ...
                                <div class="form-group col-md-6">
                                    <label class="control-label"><?php echo ('Ghi chú'); ?></label>
                                ...
                                <div class="form-group col-md-12">
                                    <label class="control-label col-md-3"> <?php echo ('Thêm thuốc tại đây'); ?></label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group col-md-12 panel-body">
                                    <label class="control-label col-md-3"><?php echo ('Chi tiết thuốc'); ?></label>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.each($('select.medicinee option:selected'), function () {
         ...
         <div class = "form-group medicine_sect col-md-5"><div class=col-md-12>\n\
<label> <?php echo ("Tên thuốc"); ?> </label>\n\
</div>\n\
\n\
<div class=col-md-12>\n\
<input class = "medi_div" name = "med_id[]" value = "' + med_name + '" placeholder="" >\n\
 <input type="hidden" id="med_id-' + id + '" class = "medi_div" name = "medicine[]" value = "' + med_id + '" placeholder="" >\n\
 </div>\n\
 </div>\n\
\n\
<div class = "form-group medicine_sect col-md-5" ><div class=col-md-12>\n\
<label><?php echo ("Số Lượng / ghi chú "); ?> </label>\n\
</div>\n\
<div class=col-md-12><input class = "state medi_div" name = "dosage[]" value = "' + dosage + '" placeholder="" >\n\
 </div>\n\
 </div>\n\
\n\
\n\
...
\n\
<div class = "form-group medicine_sect col-md-5" ><div class=col-md-12>\n\
<label><?php echo ("Liều lượng / ghi chú"); ?> </label>\n\
</div>\n\
<div class=col-md-12><input class = "state medi_div" name = "dosage[]" value = "" placeholder="" >\n\
 </div>\n\
 </div>\n\
\n\
\n\
