                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Nurse', 'Doctor', 'Laboratorist', 'Receptionist'))) { ?>
                            <?php if (in_array('patient', $this->modules)) { ?>
                                 <li class="sub-menu">
                                    <a href="javascript:;" >
                                        <i class="fa fa-users"></i> 
                                        <span><?php echo ('Bệnh nhân'); ?></span>
                                    </a>
                                    <ul class="sub"> 
                                        <li><a href="patient"><i class="fa fa-user"></i><?php echo ('Danh sách bệnh nhân'); ?></a></li>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Pharmacist'))) { ?>
                            <?php if (in_array('prescription', $this->modules)) { ?>
                                    ...
                                    <a href="javascript:;" >
                                        ...
                                        <span><?php echo ('Toa thuốc'); ?></span>
                                    </a>
                                    <ul class="sub">
                                        <li>  <a href="prescription/all" >
                                        <i class="fa fa-stethoscope"></i>
                                        <span> <?php echo ('Danh sách Toa thuốc'); ?> </span>
                                    </a></li>
                                        <li>  <a href="prescription/addPrescriptionView" >
                                        <i class="fa fa-stethoscope"></i>
                                        <span> <?php echo ('Thêm Toa thuốc'); ?> </span>
                                    </a></li>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                            <?php if (in_array('medicine', $this->modules)) { ?>
                                <li class="sub-menu">
                                    <a href="javascript:;" >
                                        <i class="fa  fa-medkit"></i>
                                        <span><?php echo ('Quản lý thuốc'); ?></span>
                                    </a>
                                    <ul class="sub">
                                        <li><a  href="medicine"><i class="fa fa-medkit"></i><?php echo ('Danh sách thuốc'); ?></a></li>
                                        <li><a  href="medicine/addMedicineView"><i class="fa fa-plus-circle"></i><?php echo ('Thêm thuốc'); ?></a></li>
                                        <li><a  href="medicine/medicineCategory"><i class="fa fa-edit"></i><?php echo ('Thể Loại'); ?></a></li>
                                        <li><a  href="medicine/addCategoryView"><i class="fa fa-plus-circle"></i><?php echo ('Thêm thể loại'); ?></a></li>
                            ...
                            <?php if (in_array('pharmacy', $this->modules)) { ?>
                                <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                        ...
                                        <?php } ?>
                                        <li><a  href="finance/pharmacy/payment"><i class="fa fa-money"></i> <?php echo ('Danh sách toa thuốc'); ?></a></li>
                                        <li><a  href="finance/pharmacy/addPaymentView"><i class="fa fa-plus-circle"></i><?php echo ('Thêm toa thuốc'); ?></a></li>
