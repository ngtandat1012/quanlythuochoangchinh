                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-md-6 row">     
                                ...
                                <div class="col-md-8 payment">
                                    <div class="form-group last">
                                        <div class="col-md-6 payment_label row"> 
                                            <label for="exampleInputEmail1"> <?php echo ('Danh sách thuốc'); ?></label>
                                        </div>
                            ...
                            <div class="col-md-4 right-six">
                                ...
                                <div class="col-md-12 payment right-six">
                                    <div class="col-md-3 payment_label"> 
                                        <label for="exampleInputEmail1"> <?php echo ('Chuẩn đoán / ghi chú'); ?><?php
                                            if ($discount_type == 'text') {
                                                echo ' (%)';
                                            }
                                            ?> </label>
                                    </div>
                                    <div class="col-md-9"> 
                                        ...
                                        ?>' placeholder="Chuẩn đoán / ghi chú">
                                    </div>
                                </div>
        ...
        $.each($('select.multi-select option:selected'), function () {
            ...
            if ($('#idinput-' + id).length)
            {
                ...
                if ($('#id-div' + id).length)
                {
                    ...
                    $("#editPaymentForm .qfloww").append('<div class="remove1" id="id-div' + id + '"><div class="name pos_element"> Tên: ' + $(this).data("m_name") + '</div><div class="current_stock pos_element">Số lượng hiện tại: ' + $(this).data('cs') + '</div><div class="quantity pos_element">Liều lượng:<div></div>')
                }
